      ...
      <div className={styles.info} onClick={handlePersonal}>
        <div className={styles.follow}>
          <div>
            <BsPersonHeart
              ...
              style={{ color: "rgb(85, 190, 255)" }}></BsPersonHeart>
          </div>
          <div>我的粉丝</div>
        ...
        <div className={styles.followed}>
          <div>
            <BsPersonHearts
              className={styles.icon}
              style={{ color: "rgb(255, 251, 5)" }}></BsPersonHearts>
          </div>
          <div>我的关注</div>
        ...
        <div className={styles.like}>
          <div>
            <AiFillHeart
              className={styles.icon}
              style={{ color: "rgb(255, 5, 5)" }}></AiFillHeart>
          </div>
          <div>我的喜欢</div>
        ...
        <div className={styles.self}>
          <div>
            <AiFillVideoCamera
              className={styles.icon}
              style={{ color: "rgb(0, 255, 187)" }}></AiFillVideoCamera>
          </div>
          <div>我的视频</div>
